...
INSERT INTO `health_claims` (`user_id`, `service_date`, `provider_firstname`, `provider_lastname`, `patient_firstname`, `patient_lastname`, `treatment_type`, `treatment_outpatient`, `treatment_inpatient`, `treatment_notes`, `payment_pos`, `payment_invoiced`, `insurance_primary`, `insurance_secondary`, `insurance_tertiary`, `have_providersubmitted_primary`, `have_providersubmitted_secondary`, `have_providersubmitted_tertiary`, `have_invoice`, `have_submittedclaim_primary`, `have_submittedclaim_secondary`,`have_submittedclaim_tertiary`, `have_eob_primary`, `have_eob_secondary`, `have_eob_tertiary`, `have_completedclaim`)
VALUES
	('1', '2017-10-02','Jackson','Pollack','Joseph','Schmosef', 'Doctor Visit', FALSE, TRUE, 'The doctor evaluated a crzy rash on my neck.', '25', '0', 'Seton Select', null, null, TRUE, null, null, FALSE, TRUE, null, null, FALSE, null, null, FALSE),
	('2', '2018-01-02','Havea','Lollipop','Mika','Jerbanovich', 'Specialist Visit', FALSE, TRUE, 'Needed more pain meds.', '35', '0', 'Crappy Insurance Co', null, null, TRUE, null, null, FALSE, TRUE, null, null, FALSE, null, null, FALSE),
	('2', '2018-01-02','Hale','Tothechief','Janice','Jerbanovich', 'Specialist Visit', TRUE, FALSE, 'Needed some counseling.', '100', '0', 'Crappy Insurance Co', null, null, FALSE, null, null, TRUE, FALSE, null, null, FALSE, null, null, FALSE);
...
VALUES
	...
	('Havea', 'Lollipop', 'Internal Medicine', "St. David's", TRUE, 'TheGoodInsCo'),
